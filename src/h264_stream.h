...
#define PPS_TABLE_SIZE          256
#define SPS_TABLE_SIZE          32
#define MAX_PICTURE_TIMESTAMP   3   // 3 is the maximum possible value
...
typedef struct {
    ...
    int _more_rbsp_data_present; // set if we carry any of the optional headers
...
typedef struct {
    ...
    int pic_struct;
    picture_timestamp_t clock_timestamps[MAX_PICTURE_TIMESTAMP];
...
typedef struct {
    ...
    sps_t* sps_table[SPS_TABLE_SIZE];
    pps_t* pps_table[PPS_TABLE_SIZE];
    sei_t** seis;
} h264_stream_t;
...
void read_sps_rbsp(h264_stream_t* h, bs_t* b);
void read_pps_rbsp(h264_stream_t* h, bs_t* b);
void read_sei_rbsp(h264_stream_t* h, bs_t* b);
void read_aud_rbsp(h264_stream_t* h, bs_t* b);
...
void write_sps_rbsp(h264_stream_t* h, bs_t* b);
void write_pps_rbsp(h264_stream_t* h, bs_t* b);
...
void write_aud_rbsp(h264_stream_t* h, bs_t* b);
